...
local function PlaySparksAnim(proxy)
    ...
    inst.AnimState:SetBuild("sch_hit_sparks_fx")
...
local function MakeSparks(name, fxfn, variation, doubleflip)
    local function fn()
        ...
        inst.flip = (doubleflip and net_tinybyte or net_bool)(inst.GUID, "sch_weaponsparks.flip")
...
return MakeSparks("sch_weaponsparks", PlaySparksAnim, "normal"), --- Used
    MakeSparks("sch_weaponsparks_piercing", Piercing_PlaySparksAnim, "piercing", true),
    MakeSparks("sch_weaponsparks_thrusting", Thrusting_PlaySparksAnim, "piercing", true),
    MakeSparks("sch_weaponsparks_bounce", Bounce_PlaySparksAnim), --- Used
    MakeSparks("sch_hit_sparks_fx", Bounce_PlaySparksAnim) --------- Client LOG
