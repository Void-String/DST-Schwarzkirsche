...
local function fn()
    ...
    inst.AnimState:SetBuild("sch_street_lamp_short")
	...
	inst.MiniMapEntity:SetIcon( "sch_street_lamp_short.tex" )
...
return Prefab("sch_street_lamp_short", fn, assets, prefabs),
    MakePlacer("sch_street_lamp_short_placer", "baka_lamp_short", "sch_street_lamp_short", "idle_off")